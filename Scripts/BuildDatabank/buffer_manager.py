...
class BufferManager:
    ...
    def calculate_ionic_strength(self, component: str) -> float:
        ...
        if component in ("H2O", "D2O", "entity_1", "asyn", "ICL2", "LysRS residues 1-72", "entity", "alpha-synuclein", "protein", "Alpha-synuclein", "intrinsically disordered alpha-synuclein", "alpha synuclein", "Synuclein","hZIP4 intracellular loop 2","protease inhibitors (Roche)", "Calmodulin","EN2", "Engrailed 2","AEBSF protease inhibitor","leupeptin","pepstatin A","CEREBRAL DOPAMINE NEUROTROPHIC FACTOR","CI2_wild-type","IGF2R", "WT TDP-43_267-414","CD69","ERD14","CI2_L49I","RelA dimerization domain","PrSH3","stromelysin","Kinase Interacting FHA (KI-FHA) domain from KAPP","p50 dimerization domain","K Phos","PNU-107859","CLV1 pT868 peptide","Neuromedin C","H2A","sgf11","Domain_11","Nedd4 WW3* domain","LangCRD","SDS","apo Bromodomain 1 (BD1) of BRD4","","nc2","imidazole","H2B","alpha ENaC PY peptide","H4Kac","Shank1 PDZ domain","Nchi2","DREB2A","Gag polyprotein (Pr55Gag)","sgf73","cAMP-dependent protein kinase A Inhibitor alpha (PKIA)","MBD1_CXXC1","CI2_I57V","Whirlin PDZ1-PDZ2","ARR_CleD","N-terminal domain of Tissue Inhibitor of Metalloproteinases-1","THAP domain","Shc-PTB","repetitive domain spider dragline silk","H2A","H2B","H3","H4","145 bp DNA","W1","W2","Integrin_beta3","MatrixMetalloProteinases-3(catalytic domain)","RRM1","PNU-142372","C2E","(2S)-N-methyl-3-(2,3,4,5,6-pentafluorophenyl)-2-({[(5-thioxo-4,5-dihydro-1,3,4-thiadiazol-2-yl)amino]carbonyl}amino)propanamide","TonB CTD","PaTonB96","TonB","MANF","AcSp1","Galectin-3"):
            return 0.0
